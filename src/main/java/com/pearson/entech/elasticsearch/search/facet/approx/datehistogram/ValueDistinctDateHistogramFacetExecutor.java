 ...
 */
public class ValueDistinctDateHistogramFacetExecutor extends FacetExecutor {
    ...
    public ValueDateHistogramFacetExecutor(final IndexNumericFieldData keyIndexFieldData, final IndexNumericFieldData valueIndexFieldData,
            final TimeZoneRounding tzRounding, final DateHistogramFacet.ComparatorType comparatorType) {
    ...
    public static class DateHistogramProc extends LongFacetAggregatorBase {
        ...
        public DateHistogramProc(final TimeZoneRounding tzRounding, final ExtTLongObjectHashMap<InternalFullDateHistogramFacet.FullEntry> entries) {
            this.tzRounding = tzRounding;
        ...
        public final static class ValueAggregator extends DoubleFacetAggregatorBase {
            ...
            @Override
            public void onValue(final int docId, final double value) {
                entry.totalCount++;
                entry.total += value;
                if(value < entry.min) {
                    entry.min = value;
